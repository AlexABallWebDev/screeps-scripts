...
const spawnFunctions = {
  ...
  */
  createCreepWithMemory(spawn: StructureSpawn, memory: any, body: BodyPartConstant[] = [WORK, CARRY, MOVE, MOVE],
  ...
  @param {string} name = undefined
  */
  createCreepWithRole(spawn: StructureSpawn, role: string, body: BodyPartConstant[] = [WORK, WORK, CARRY, MOVE],
    name: any = undefined): string {
    return this.createCreepWithMemory(spawn, {
      role: role
    }, body, name);
  },
