...
export const defender = [ATTACK, ATTACK, MOVE, MOVE, ATTACK, ATTACK, MOVE, MOVE];
export const harvester = [WORK, MOVE, CARRY, MOVE];
export const courier = [CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE, CARRY, MOVE, CARRY,
  MOVE, CARRY, MOVE, CARRY, MOVE, CARRY, MOVE, CARRY, MOVE, CARRY, MOVE, CARRY
];
export const miner = [WORK, WORK, MOVE, WORK, WORK, MOVE, WORK];
export const builder = [WORK, WORK, CARRY, MOVE, MOVE, MOVE, CARRY, WORK, MOVE, CARRY,
  WORK, MOVE, CARRY, WORK, MOVE, CARRY, WORK, MOVE, CARRY, WORK, MOVE, CARRY, WORK
];
export const upgrader = [WORK, WORK, CARRY, MOVE, CARRY, WORK, MOVE, WORK, WORK,
  MOVE, CARRY, WORK, MOVE, WORK, WORK, MOVE, CARRY, WORK, MOVE, WORK, WORK, MOVE
];
export const claimer = [CLAIM, MOVE];
export const colonist = [WORK, MOVE, CARRY, MOVE, MOVE, WORK, MOVE, CARRY, MOVE, WORK,
...
@param {array} body
*/
export function calculateSpawnTime(body: BodyPartConstant[]): number {
...
*/
export function calculateTicksPerMove(body: BodyPartConstant[]): number {
  let movePartCount = 0;
...
*/
export function sortBody(body: BodyPartConstant[], priorities: any = {
  [TOUGH]: 0,
  [WORK]: 1,
  [MOVE]: 2,
  [CARRY]: 3,
...
@param {BodyPartConstant[]} body
*/
export function trimExtraParts(room: Room, body: BodyPartConstant[]): BodyPartConstant[] {
